...
typedef std::map<std::string, FeatureHandler> FeatureHandlers;
 ...
 */
template<class A,
         class E1 = End, class E2 = End, class E3 = End, class E4 = End,
         class E5 = End, class E6 = End, class E7 = End, class E8 = End>
struct MixinTree
	: E1::template I<A>
	, MixinTree<A, E2, E3, E4, E5, E6, E7, E8>
{
...
/** @internal
 * Specialisation of the inheritance tree template that terminates the
 * recursion.
 */
template<class A>
struct MixinTree<A, End, End, End, End, End, End, End, End> {
	static void        map_feature_handlers(FeatureHandlers& hmap) {}
